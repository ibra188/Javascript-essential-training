...
document.querySelector(".left .coloe-value").innerHTML = color;

color = "skyblue";
function headingColor(){
  let color =  "blue";
  document.querySelector(".tittle").getElementsByClassName.color = color;
}

headingColor()

document.querySelector(".right").getElementsByClassName.backgroundColor = color;
